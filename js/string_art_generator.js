...
StringArtGenerator.prototype.ShowInfo = function(linesCount, totalCount, startTime) {
    ...
    this.infoBox.innerHTML += `<b>Прошйло часу:</b> ${time}<br>`
    this.infoBox.innerHTML += `<b>Залишилось часу:</b> ${lost}<br>`
    this.infoBox.innerHTML += `<b>Сер. час ліній:</b> ${avg} мс`
}
